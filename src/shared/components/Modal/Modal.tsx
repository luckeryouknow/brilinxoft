...
export default function Modal ({ modalClick, modalDisplay }: Props) {
  return (
    <div 
      ...
      itemType="reset"
      >
      <div className="fixed w-[372px] z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-[2px] rounded-[20px] bg-gradient-to-r from-[#3892F5FF] via-[#B519F4FF] to-[#F10BD0FF] md:w-[400px] xl:w-[600px]">
        <div
