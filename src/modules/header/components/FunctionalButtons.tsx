  ...
  return (
    <div className="flex flex-col-reverse mt-10 gap-8 md:flex-row md:items-center md:mt-0 md:font-semibold">
      <div className="flex flex-col gap-6 w-fit md:flex-row md:gap-8">
        <button className="text-left md:text-center" onClick={aboutClick}>About</button>
        <button className="text-left md:text-center" onClick={servicesClick}>Services</button>
        <button className="text-left md:text-center" onClick={contactsClick}>Contacts</button>
      </div>
